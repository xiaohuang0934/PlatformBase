...
<template>
  <div class="page-container">
    <div class="page-header"><h2 class="page-header__title">文件管理</h2></div>
    ...
    <el-table v-if="searched" v-loading="loading" :data="list" border stripe row-key="id">
      ...
      <el-table-column label="上传时间" width="170"><template #default="{ row }">{{ parseTime(row.createdAt) }}</template></el-table-column>
